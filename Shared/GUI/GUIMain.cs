...
namespace LudumDare46.Shared.GUI
{
    class GUIMain
    {
        ...
        public GUIMain(GraphicsDeviceManager graphics)
        {
            ...
            var stackTest = new DemoViewModel("Stack Panels",
                new StackPanel
                {
                    Items =
                    {
                        new Button
                        {
                            Content = "Press Me", HorizontalAlignment = HorizontalAlignment.Left,
                            VerticalAlignment = VerticalAlignment.Top
                        },
                        new Button
                        {
                            Content = "Press Me", HorizontalAlignment = HorizontalAlignment.Right,
                            VerticalAlignment = VerticalAlignment.Bottom
                        },
                        new Button
                        {
                            Content = "Press Me", HorizontalAlignment = HorizontalAlignment.Centre,
                            VerticalAlignment = VerticalAlignment.Centre
                        },
                        new Button
                        {
                            Content = "Press Me", HorizontalAlignment = HorizontalAlignment.Stretch,
            ...
            var controlTest = new DemoViewModel("Basic Controls",
                new StackPanel
                {
                    ...
                    Items =
                    {
                        ...
                        new ComboBox
                        {
                            Items = {"ComboBoxItemA", "ComboBoxItemB", "ComboBoxItemC"}, SelectedIndex = 0,
